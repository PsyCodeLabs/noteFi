...
function HeroSection() {
  return (
    ...
    >
      <section className="py-12">  {/* Changed background color to dark */}
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-white"><span className='text-emerald-600'>noteFi</span> A Truly Decentralized options for canto</h1>  {/* Changed text color to white */}
