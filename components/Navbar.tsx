      ...
      <nav className="bg-gray-900 border-gray-700 px-4 lg:px-6 py-2.5 dark:bg-gray-900 border-b">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <div className="flex items-center">
            <Image className="h-10 w-24 mr-2" src={logo} alt="noteFi" />
          ...
          <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              <Link href="/">
              <li>
                <div  className="block py-2 pr-4 pl-3 text-emerald-400 rounded bg-transparent lg:bg-transparent lg:text-emerald-400 lg:p-0 dark:text-white" aria-current="page">
                  Home
                </div>
              </li>
              </Link>
                ...
                {dropdownOpen && (
                  <div className="mt-8 absolute z-10 bg-gray-800 rounded-lg shadow w-44 dark:bg-gray-800">
                    <ul className="py-2 text-sm text-gray-200 dark:text-gray-200">
                      <Link href="/write">
                      <li>
                        <div className="block px-4 py-2 hover:bg-gray-700 dark:hover:bg-gray-700 dark:hover:text-white">
                          Write Option
                        </div>
                      </li>
                      </Link>
              ...
              <Link href="/positions">
              <li>
                <div className="block py-2 pr-4 pl-3 text-gray-400 border-b border-gray-700 hover:bg-gray-800 lg:hover:bg-transparent lg:border-0 lg:hover:text-emerald-400 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-800 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">
                  Positions
                </div>
              </li>
              </Link>
