        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          ...
          <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            ...
            <div className="feature-card bg-emerald-800 rounded-lg p-6 flex flex-col items-center justify-center text-center hover:bg-emerald-900 transition duration-300 ease-in-out transform hover:scale-105">
              ...
              <h3 className="mb-2 text-xl font-bold text-white">Risk Management</h3>
            ...
            <div className="feature-card bg-emerald-800 rounded-lg p-6 flex flex-col items-center justify-center text-center hover:bg-emerald-900 transition duration-300 ease-in-out transform hover:scale-105">
              ...
              <p className="text-gray-400">Enjoy a seamless and intuitive platform designed to enhance your trading experience, accessible from any device.</p>
            </div>
          </div>
        </div>
      </section>
